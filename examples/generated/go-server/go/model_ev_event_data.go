...
// EvEventData - Payload for `ev/_*` events. The event describes the change of an EV's state at a charging station. 
type EvEventData struct {
...
// AssertEvEventDataRequired checks if the required fields are not zero-ed
func AssertEvEventDataRequired(obj EvEventData) error {
...
// AssertEvEventDataConstraints checks if the values respects the defined constraints
func AssertEvEventDataConstraints(obj EvEventData) error {
	return nil
}
