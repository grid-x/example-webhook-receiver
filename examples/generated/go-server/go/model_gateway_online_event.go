...
// AssertGatewayOnlineEventRequired checks if the required fields are not zero-ed
func AssertGatewayOnlineEventRequired(obj GatewayOnlineEvent) error {
...
// AssertGatewayOnlineEventConstraints checks if the values respects the defined constraints
func AssertGatewayOnlineEventConstraints(obj GatewayOnlineEvent) error {
	return nil
}
