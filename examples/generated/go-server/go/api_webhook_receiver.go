...
func (c *WebhookReceiverAPIController) Routes() Routes {
	return Routes{
		"EventsEventTypePost": Route{
			strings.ToUpper("Post"),
			"/gridx/events/{eventType}",
			c.EventsEventTypePost,
		},
	}
}

// EventsEventTypePost - Webhook Receiver
func (c *WebhookReceiverAPIController) EventsEventTypePost(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	eventTypeParam := params["eventType"]
	...
	result, err := c.service.EventsEventTypePost(r.Context(), eventTypeParam, xSignatureParam, eventParam)
