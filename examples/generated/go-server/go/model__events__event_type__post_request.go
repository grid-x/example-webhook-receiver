...
type EventsEventTypePostRequest struct {
	Id string `json:"id"`
...
// AssertEventsEventTypePostRequestRequired checks if the required fields are not zero-ed
func AssertEventsEventTypePostRequestRequired(obj EventsEventTypePostRequest) error {
...
// AssertEventsEventTypePostRequestConstraints checks if the values respects the defined constraints
func AssertEventsEventTypePostRequestConstraints(obj EventsEventTypePostRequest) error {
	return nil
}
