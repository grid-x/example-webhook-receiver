...
class EVEventData(Model):
    ...
    def __init__(self, appliance_id: str=None, gateway_id: str=None, model: str=None, manufacturer: str=None, type: str=None, kind: str=None, name: str=None, serial_number: str=None, system_id: str=None, system_name: str=None, evse_id: str=None, state: str=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'EVEventData':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The EVEventData of this EVEventData.
        """
