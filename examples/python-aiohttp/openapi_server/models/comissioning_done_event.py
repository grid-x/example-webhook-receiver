...
class ComissioningDoneEvent(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, id: str=None, time: datetime=None, data_content_type: str='application/json', spec_version: str=None, source: str=None, correlation_id: str=None, type: str=None, data: CommissioningData=None):
        """ComissioningDoneEvent - a model defined in OpenAPI

        :param id: The id of this ComissioningDoneEvent.
        :param time: The time of this ComissioningDoneEvent.
        :param data_content_type: The data_content_type of this ComissioningDoneEvent.
        :param spec_version: The spec_version of this ComissioningDoneEvent.
        :param source: The source of this ComissioningDoneEvent.
        :param correlation_id: The correlation_id of this ComissioningDoneEvent.
        :param type: The type of this ComissioningDoneEvent.
        :param data: The data of this ComissioningDoneEvent.
        """
        self.openapi_types = {
            'id': str,
            'time': datetime,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ComissioningDoneEvent':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ComissioningDoneEvent of this ComissioningDoneEvent.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def id(self):
        """Gets the id of this ComissioningDoneEvent.


        :return: The id of this ComissioningDoneEvent.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ComissioningDoneEvent.
    ...
    @property
    def time(self):
        """Gets the time of this ComissioningDoneEvent.

        Time when the event has occurred in RFC3339 format.

        :return: The time of this ComissioningDoneEvent.
        :rtype: datetime
        """
        return self._time
    ...
    @time.setter
    def time(self, time):
        """Sets the time of this ComissioningDoneEvent.
    ...
    def spec_version(self):
        """Gets the spec_version of this ComissioningDoneEvent.
        ...
        :return: The spec_version of this ComissioningDoneEvent.
        :rtype: str
        """
    ...
    def spec_version(self, spec_version):
        """Sets the spec_version of this ComissioningDoneEvent.
    ...
    @property
    def source(self):
        """Gets the source of this ComissioningDoneEvent.
        ...
        :return: The source of this ComissioningDoneEvent.
        :rtype: str
        """
        return self._source
    ...
    def source(self, source):
        """Sets the source of this ComissioningDoneEvent.
    ...
    def correlation_id(self):
        """Gets the correlation_id of this ComissioningDoneEvent.

        ID to identify the request triggering the event.

        :return: The correlation_id of this ComissioningDoneEvent.
        :rtype: str
        """
    ...
    def correlation_id(self, correlation_id):
        """Sets the correlation_id of this ComissioningDoneEvent.
    ...
    @property
    def data(self):
        """Gets the data of this ComissioningDoneEvent.


        :return: The data of this ComissioningDoneEvent.
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this ComissioningDoneEvent.


        :param data: The data of this ComissioningDoneEvent.
        :type data: CommissioningData
        """
