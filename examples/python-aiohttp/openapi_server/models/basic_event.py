...
class BasicEvent(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, id: str=None, time: datetime=None, data_content_type: str='application/json', spec_version: str=None, source: str=None, correlation_id: str=None):
        """BasicEvent - a model defined in OpenAPI

        :param id: The id of this BasicEvent.
        :param time: The time of this BasicEvent.
        :param data_content_type: The data_content_type of this BasicEvent.
        :param spec_version: The spec_version of this BasicEvent.
        :param source: The source of this BasicEvent.
        :param correlation_id: The correlation_id of this BasicEvent.
        """
        self.openapi_types = {
            'id': str,
            'time': datetime,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'BasicEvent':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The BasicEvent of this BasicEvent.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def id(self):
        """Gets the id of this BasicEvent.


        :return: The id of this BasicEvent.
        :rtype: str
        """
        return self._id
    ...
    @property
    def time(self):
        """Gets the time of this BasicEvent.

        Time when the event has occurred in RFC3339 format.

        :return: The time of this BasicEvent.
        :rtype: datetime
        """
        return self._time
    ...
    @time.setter
    def time(self, time):
        """Sets the time of this BasicEvent.
    ...
    def spec_version(self):
        """Gets the spec_version of this BasicEvent.
        ...
        :return: The spec_version of this BasicEvent.
        :rtype: str
        """
    ...
    def spec_version(self, spec_version):
        """Sets the spec_version of this BasicEvent.
    ...
    @property
    def source(self):
        """Gets the source of this BasicEvent.
        ...
        :return: The source of this BasicEvent.
        :rtype: str
        """
        return self._source
    ...
    def source(self, source):
        """Sets the source of this BasicEvent.
    ...
    def correlation_id(self):
        """Gets the correlation_id of this BasicEvent.

        ID to identify the request triggering the event.

        :return: The correlation_id of this BasicEvent.
        :rtype: str
        """
    ...
    def correlation_id(self, correlation_id):
        """Sets the correlation_id of this BasicEvent.
