...
// Middleware returns an http.Handler to be used as an HTTP middleware for verifying HMAC signatures of gridX
// webhook event requests.
func (v *RequestVerifier) Middleware(next http.Handler) http.HandlerFunc {
