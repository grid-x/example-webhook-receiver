...
type ComissioningDoneEvent struct {
	Id string `json:"id"`
	...
	Data CommissioningData `json:"data,omitempty"`
}

// AssertComissioningDoneEventRequired checks if the required fields are not zero-ed
func AssertComissioningDoneEventRequired(obj ComissioningDoneEvent) error {
	...
	if err := AssertCommissioningDataRequired(obj.Data); err != nil {
		return err
	}
	return nil
}

// AssertComissioningDoneEventConstraints checks if the values respects the defined constraints
func AssertComissioningDoneEventConstraints(obj ComissioningDoneEvent) error {
	return nil
}
