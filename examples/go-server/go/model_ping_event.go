...
// AssertPingEventRequired checks if the required fields are not zero-ed
func AssertPingEventRequired(obj PingEvent) error {
	...
	if err := AssertPingEventDataRequired(obj.Data); err != nil {
		return err
	}
	return nil
}

// AssertPingEventConstraints checks if the values respects the defined constraints
func AssertPingEventConstraints(obj PingEvent) error {
	if err := AssertPingEventDataConstraints(obj.Data); err != nil {
		return err
	}
	return nil
}
