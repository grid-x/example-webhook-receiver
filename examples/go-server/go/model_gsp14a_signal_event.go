...
type Gsp14aSignalEvent struct {
	...
	Data Gsp14aSignalEventData `json:"data"`
}

// AssertGsp14aSignalEventRequired checks if the required fields are not zero-ed
func AssertGsp14aSignalEventRequired(obj Gsp14aSignalEvent) error {
	...
	if err := AssertGsp14aSignalEventDataRequired(obj.Data); err != nil {
		return err
	}
	return nil
}

// AssertGsp14aSignalEventConstraints checks if the values respects the defined constraints
func AssertGsp14aSignalEventConstraints(obj Gsp14aSignalEvent) error {
	if err := AssertGsp14aSignalEventDataConstraints(obj.Data); err != nil {
		return err
	}
	return nil
}
