...
// AssertBasicEventRequired checks if the required fields are not zero-ed
func AssertBasicEventRequired(obj BasicEvent) error {
...
// AssertBasicEventConstraints checks if the values respects the defined constraints
func AssertBasicEventConstraints(obj BasicEvent) error {
	return nil
}
