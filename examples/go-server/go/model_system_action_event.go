...
type SystemActionEvent struct {
	...
	Data SystemActionEventData `json:"data"`
}

// AssertSystemActionEventRequired checks if the required fields are not zero-ed
func AssertSystemActionEventRequired(obj SystemActionEvent) error {
	...
	if err := AssertSystemActionEventDataRequired(obj.Data); err != nil {
		return err
	}
	return nil
}

// AssertSystemActionEventConstraints checks if the values respects the defined constraints
func AssertSystemActionEventConstraints(obj SystemActionEvent) error {
	if err := AssertSystemActionEventDataConstraints(obj.Data); err != nil {
		return err
	}
	return nil
}
