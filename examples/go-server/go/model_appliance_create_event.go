...
// AssertApplianceCreateEventRequired checks if the required fields are not zero-ed
func AssertApplianceCreateEventRequired(obj ApplianceCreateEvent) error {
...
// AssertApplianceCreateEventConstraints checks if the values respects the defined constraints
func AssertApplianceCreateEventConstraints(obj ApplianceCreateEvent) error {
	return nil
}
