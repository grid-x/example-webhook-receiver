...
type ApplianceEvent struct {
	...
	Data ApplianceEventData `json:"data"`
}

// AssertApplianceEventRequired checks if the required fields are not zero-ed
func AssertApplianceEventRequired(obj ApplianceEvent) error {
...
// AssertApplianceEventConstraints checks if the values respects the defined constraints
func AssertApplianceEventConstraints(obj ApplianceEvent) error {
	if err := AssertApplianceEventDataConstraints(obj.Data); err != nil {
		return err
	}
	return nil
}
