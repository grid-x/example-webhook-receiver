...
type GatewayOfflineEvent struct {
	Id string `json:"id"`
...
// AssertGatewayOfflineEventRequired checks if the required fields are not zero-ed
func AssertGatewayOfflineEventRequired(obj GatewayOfflineEvent) error {
...
// AssertGatewayOfflineEventConstraints checks if the values respects the defined constraints
func AssertGatewayOfflineEventConstraints(obj GatewayOfflineEvent) error {
	return nil
}
