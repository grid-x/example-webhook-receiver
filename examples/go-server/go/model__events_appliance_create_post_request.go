...
type EventsApplianceCreatePostRequest struct {
	Id string `json:"id"`
	...
	Data GatewayEventData `json:"data,omitempty"`
}

// AssertEventsApplianceCreatePostRequestRequired checks if the required fields are not zero-ed
func AssertEventsApplianceCreatePostRequestRequired(obj EventsApplianceCreatePostRequest) error {
	...
	if err := AssertGatewayEventDataRequired(obj.Data); err != nil {
		return err
	}
	return nil
}

// AssertEventsApplianceCreatePostRequestConstraints checks if the values respects the defined constraints
func AssertEventsApplianceCreatePostRequestConstraints(obj EventsApplianceCreatePostRequest) error {
	return nil
}
