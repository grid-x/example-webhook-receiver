...
type InverterStatusEvent struct {
	...
	Data InverterEventData `json:"data,omitempty"`
}

// AssertInverterStatusEventRequired checks if the required fields are not zero-ed
func AssertInverterStatusEventRequired(obj InverterStatusEvent) error {
...
// AssertInverterStatusEventConstraints checks if the values respects the defined constraints
func AssertInverterStatusEventConstraints(obj InverterStatusEvent) error {
	return nil
}
