...
// AssertGatewayCreateEventRequired checks if the required fields are not zero-ed
func AssertGatewayCreateEventRequired(obj GatewayCreateEvent) error {
...
// AssertGatewayCreateEventConstraints checks if the values respects the defined constraints
func AssertGatewayCreateEventConstraints(obj GatewayCreateEvent) error {
	return nil
}
